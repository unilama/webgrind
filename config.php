...
class Webgrind_Config extends Webgrind_MasterConfig {
	...
	*/
     ...
     * RegExp 
     */
    static $xDebugOutputFormat = '/^cachegrind\.out\..+$/';
    static $useInixDebugOutputFormat = true;
	...
	*/
    static function xdebugOutputFormat() {
        $outputName = '';
        if( Webgrind_Config::$useInixDebugOutputFormat )
            $outputName = ini_get('xdebug.profiler_output_name');
            
		if($outputName == '') // Ini value not defined
			$outputName = Webgrind_Config::$xDebugOutputFormat;
		else
